...

{
  ...
  lucee7 = mkLuceeVersion {
    ...
    description = "Lucee jar file without dependencies Lucee needs to run";
    version = "7.0.2.106";
    sha256 = "sha256-4rzLOYm9++JPKn9YpO/vDzJLpAKiFT5CeacHZAu9yHg=";
    javaVersion = 25;
  };
  ...
  lucee7-light = mkLuceeVersion {
    ...
    description = "Lucee Jar file without any Extensions bundled, \"Lucee light\"";
    version = "7.0.2.106";
    sha256 = "sha256-Fd4pMNRXvWRnvq5naIMBgedww8LhWhQvaAz0WTN2TFw=";
    javaVersion = 25;
  };
  ...
  lucee6-zero = mkLuceeVersion {
    ...
    description = "Lucee Jar file without any Extensions bundled or doc and admin bundles, \"Lucee zero\"";
    version = "6.2.5.48";
    sha256 = "sha256-3LKhj0cIy08SQ2d+oMibScLof692y6qWk9y851bc/c8=";
    javaVersion = 25;
  };
  ...
  lucee6 = mkLuceeVersion {
    ...
    description = "Lucee jar file without dependencies Lucee needs to run";
    version = "6.2.5.48";
    sha256 = "sha256-vgzXbO2ZY6X9Qbum2NKdu8L+f2gWWylK6ApOFQKl6Vw=";
    javaVersion = 25;
  };
  ...
  lucee6-light = mkLuceeVersion {
    ...
    description = "Lucee Jar file without any Extensions bundled, \"Lucee light\"";
    version = "6.2.5.48";
    sha256 = "sha256-WuwghnmMWYPC2eCT4IAd+quu1tDqrOE65OaVGaMN8Mo=";
    javaVersion = 25;
  };
